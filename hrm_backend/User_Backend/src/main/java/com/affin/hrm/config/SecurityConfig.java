    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/api/auth/login", "/api/auth/register", "/api/auth/check-user/**", "/api/auth/debug-user/**", "/api/auth/sync-all", "/api/auth/forgot-password", "/api/auth/reset-password", "/api/auth/next-employee-id/**").permitAll()
