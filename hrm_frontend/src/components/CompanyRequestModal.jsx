...
const CompanyRequestModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4 overflow-y-auto animate-fade-in">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-100 transform transition-all my-8">
        
        {/* Header */}
        <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-indigo-700 px-8 py-6 text-white relative">
          <button
            onClick={onClose}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold tracking-tight">Request for Your Company</h2>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1">Estimated Employees</label>
                  <div className="relative">
                ...
                <div className="md:col-span-2">
                  <label className="block text-xs font-semibold text-gray-700 mb-1">Company Website (Optional)</label>
                  <div className="relative">
            ...
            <div className="border-t border-gray-100 pt-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="md:col-span-2">
                  <label className="block text-xs font-semibold text-gray-700 mb-1">Notes / Additional Information</label>
                  <textarea
                    name="notes"
                    rows="2"
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
              <button
                type="button"
                onClick={onClose}
                className="px-6 py-2.5 rounded-xl border border-gray-200 text-gray-600 font-semibold text-xs hover:bg-gray-50 transition-colors"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={loading}
                className="px-8 py-2.5 bg-gradient-to-r from-emerald-600 via-teal-600 to-indigo-600 hover:from-emerald-700 hover:to-indigo-700 text-white font-semibold text-xs rounded-xl shadow-lg transition-all flex items-center gap-2 disabled:opacity-50"
              >
                {loading ? (
                  <>
